                            ...
                            <el-table
                                ...
                                <el-table-column
                                    ...
                                    <template slot-scope="scope">
                                        <div v-for="item in scope.row.bedSize" :key="item">{{item}}</div>
                                    </template>
                                </el-table-column>
                                <el-table-column
                                    prop="breakfastType"
                                ...
                                <el-table-column
                                    ...
                                    label="推广费">
                                    <template slot-scope="scope">
                                        {{scope.row.promotionValue||0}}{{scope.row.promotionTypeStr}}
                                    </template>
                                </el-table-column>
                                <el-table-column
                                    prop="incentiveValue"
                                    label="销售激励">
                                    <template slot-scope="scope">
                                        {{scope.row.incentiveValue||0}}{{scope.row.incentiveTypeStr}}
                                    </template>
                                </el-table-column>
...
export default {
    ...
    methods: {
        getDetail(){
            this.groupHttp.get('HotelProduct/GetHotelDetail',{
                params:{
