<template>
  <div class="view">
    ...
    <el-table :data="changeTableData" border style="width: 100%" v-loading="loading">
      ...
      <el-table-column label="变更人数" width="280">
      ...
      <el-table-column fixed="right" label="操作" width="120">
        <template slot-scope="scope">
          ...
          <el-button type="text" size="small" @click="isApproved(scope.row)" v-if="scope.row.supplierCanApproval">审核</el-button>
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    ...
    exportExcel() {
      ...
      let url =process.env.WEB_API +`/GroupLineChangOrder/ExportList?Status=${this.auditStatus}&ChangeOrderNo=${this.changeOrderNo}&OrderNo=${this.orderNo}&DateFrom=${sDate}&DateTo=${eDate}&PageSize=${this.pageSize}&PageIndex=${this.currentPage}&SupplierId=`;
      this.groupHttp.get('HotelOrder/GetSupplierId').then(function (res) {
