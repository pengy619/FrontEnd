                  ...
                  <el-table-column
                      ...
                      >
                        <template slot-scope="scope">
                          <el-button type="text" size="mini" @click="convertOrder">转化订单</el-button>
                          <el-button type="text" size="mini" @click="cancelOrder">取消订单</el-button>
                        </template>
                  </el-table-column>
            </el-table>
  ...
  export default {
    methods: {
      queryData(pageSize,pageIndex){
        this.loading = true;
        this.groupHttp.post("/GroupLine/GetGroupLinePurchase", {
