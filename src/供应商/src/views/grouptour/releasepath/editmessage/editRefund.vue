<template>
  <div class='view' v-loading.fullscreen.lock="fullscreenLoading">
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
      ...
      <el-form-item label="预订规则" prop="canreserve">
      ...
      <el-form-item label="">
        <el-button type="primary" @click="submitForm('ruleForm','save',true)" size='small' :loading = 'btn_loading'>保存</el-button>
      <el-button type="primary" size='small' v-show='showSubmit' @click="submitForm('ruleForm','',true)" :loading = 'btn_loading'>保存并提交</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
...
export default {
  ...
  data() {
    ...
    var checkPricerefund = (rules, value, callback) => {
      if (
        this.ruleForm.canrefund == 1 &&
        this.ruleForm.pricerefund != 0 &&
        this.ruleForm.pricerefund != 1
      ) {
    ...
    var checkPricereserve = (rules, value, callback) => {
      if (
        this.ruleForm.canreserve == 1 &&
        this.ruleForm.pricereserve != 0 &&
        this.ruleForm.pricereserve != 1
      ) {
  ...
  methods: {
    ...
    getRefundInfo() {
      ...
      this.groupHttp
        .get("GroupLine/GetRefundInfo?lineId=" + this.$route.query.lineId)
        .then(res => {
          ...
          this.ruleForm.pricereserve =
            res.data.dto.hasDestineAmount == true ? 1 : 0;
    ...
    submitForm(ruleForm,type,bool) {
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          //this.btn_loading = true;
          this.groupHttp
            .post("/GroupLine/SaveRefundInfo", {
              IsSave:bool,
              ...
              Dto: {
                ...
                HasDestineAmount:
                  this.ruleForm.pricereserve == 1 ? true : false,
