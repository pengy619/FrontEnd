    ...
    <div class='view'>
        ...
        <el-row class='btn-row'>
            <el-col>
                ...
                <el-button type="primary" @click="createAttraction" size='small'>新建景点</el-button>
                <!-- <el-button type="primary" @click="batchAudit" :disabled="btn_batchAudit" size='small'>批量审核</el-button> -->
                <el-button type="primary" @click='goSelectAttraction' size='small'>选取景点</el-button>
            </el-col>
        </el-row>
        ...
        @selection-change="tableSelectionChange">
            ...
            <el-table-column size="small" align="center"  label="操作" fixed="right" width='200'>
                <template slot-scope="scope">
                    <el-button type="text" size="mini"  @click='edit(scope.row)' class='table-button'>编辑</el-button>
...
<script>
    ...
    export default{
        ...
        methods:{
            ...
            //跳转选取景点
            goSelectAttraction () {
                this.$router.push('/tickets/selectAttraction')
            },
            //查看
            check(row){
                this.$router.push({
            ...
            //创建套票
            createTicket(){
                this.$router.push('/Tickets/ticketsInfo')
            },
            //审核
            audit(){},
            //创建景点
