<template>
	<div class="view">
		...
		<el-row :gutter="20" type="flex" class="info-row">
			...
			<el-col :span="4">航空公司：{{this.basicInfo.airlineName}} </el-col>
			<el-col :span="4">航班类型：{{this.basicInfo.flightType==0?'国内':'国外'}}</el-col>
		</el-row>
		<el-row :gutter="20" type="flex" class="info-row">
			<el-col :span="6">
				航班号：{{this.basicInfo.flightNo}}   
			</el-col>
			<el-col :span="6">出发日期：{{this.basicInfo.departDate.substring(0,10)}} </el-col>
		</el-row>
		<el-row :gutter="20" type="flex" class="info-row">
			<el-col :span="6">
		...
		<el-row :gutter="20" type="flex" class="info-row">
			...
			<el-col :span="4">到达时间：{{this.basicInfo.arriveTime}} </el-col>
			<el-col :span="4">飞行时长：{{this.basicInfo.flightDurationHours+'小时'+this.basicInfo.flightDurationMinutes+'分钟'}} </el-col>
		</el-row>
		<el-row :gutter="20" type="flex" class="info-row">
			<el-col :span="6">
				起飞机场：{{this.basicInfo.departAirporName}} 
			</el-col>
			<el-col :span="4">到达机场：{{this.basicInfo.arriveAirportName}} </el-col>
		</el-row>
		...
		<el-form  ref="form" :model="form" :rules="rules" label-width="100px" size="small" style="margin-top: 10px;width: 50%;">
			<el-form-item label="分配账户" prop="CutCustomerName">
				<span>XXXX账户</span>
