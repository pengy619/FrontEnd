<template>
	<div class="view">
		...
		<el-table :data="table.tableData" style="width: 100%" v-loading="tableLoading" @selection-change="handleSelectionChange">
			...
			<el-table-column prop="shelvesStatus" label="销售状态" width="80">
			</el-table-column>
			<el-table-column prop="airline" label="航空公司" :show-overflow-tooltip="true"  width="80">
			</el-table-column>
			...
			<el-table-column prop="reductionSaleQuantity" label="甩位">
			</el-table-column>
					...
					.then((res) => {
						var objects=res.data.objects;
							objects.forEach(function(item,index){
								objects[index].departTime=item.departTime.substring(11,16);
								objects[index].arriveTime=item.arriveTime.substring(11,16);
							})
