			...
			<el-row>
				<el-col :span="6">
					<el-form-item label="航线" prop="AirRoute">
						<el-input v-model="form.AirRoute" placeholder="航线"></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="6">
			...
			<el-row>
				...
				<el-col :span="6">
					<el-form-item label="行程天数" prop="NumberOfDays">
						<el-input v-model="form.NumberOfDays" placeholder=""></el-input>
					</el-form-item>
				</el-col>
			</el-row>
				...
				<el-row>
					<el-col :span="7">
						<el-form-item label="航班号" :prop="'FlightNo'+(type+1)">
							<el-input v-model="trip.FlightNo" placeholder=""></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="7">
							...
							<div style="width: 200px;">
								<el-col :span="9">
									<el-form-item :prop="'ArriveDays'+(type+1)">
										<el-input-number style="width:65px" @blur="airArriveDays(type)" :controls="false" v-model="trip.ArriveDays" :min="0" placeholder="" class="air-time"></el-input-number>
									</el-form-item>
								</el-col>
  	...
  	data() {
		...
		let checkDepartTime1 = (rule, value, callback) => {
			...
			if (!departTime) {
				...
				return callback(new Error('起飞时间小于到达时间，请修改起飞时间'));
			}else{
				callback();
			}
		};
		...
		let checkArriveTime1 = (rule, value, callback) => {
			...
			if (!arriveTime) {
				...
				return callback(new Error('起飞时间小于到达时间，请修改到达时间'));
			}else{
				callback();
			}
		...
		let  arriveDays1= (rule, value, callback) => {
			...
			if (v==='') {
				...
				return callback(new Error('起飞时间小于到达时间，请修改间隔天数'));
			}else{
				callback();
			}
		};
