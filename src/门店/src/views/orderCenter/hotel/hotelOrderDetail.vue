                ...
                <el-row :gutter="20">
                    <el-col :span="10">
                        <el-form-item label="床型" size="small" label-width="100px">
                            <span style="margin-right:5px" v-for="(item,index) in JSON.parse(detail.roomInfoJson).BedInfo" :key="index"><span v-if="index>0">，</span>{{item}}</span>
                        </el-form-item>
                    </el-col>
                    <el-col :span="10">
...
export default {
    ...
    methods: {
        getDetail(){
            this.shopHttp.post('HotelOrder/GetHotelOrderDetailInfoByOrderId',{
