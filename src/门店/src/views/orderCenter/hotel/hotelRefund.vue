<template>
  <div class="view" id="box">
    ...
    <el-table size="small" ref="multipleTable" border :data="customerFeeInitInfo.orderInfos" max-height="800" tooltip-effect="dark" style="width: 100%">
        ...
        <el-table-column size="small" prop="cusRefundedFee" label="已退" align="center" show-overflow-tooltip>
        </el-table-column>
    ...
    <el-row :gutter="24" style="margin-top:30px;padding-left:40%;">
            <el-button size="small" type="primary" @click = 'confirmRefund' :loading="btnLoading">确认退款</el-button>
            <el-button size="small" type="primary" @click = '$router.go(-1)'>取 消</el-button>
    </el-row>
  </div>
</template>
        ...
        confirmRefund(){
            ...
            this.$refs.formData.validate( (valid) => {
                if(valid){
                    ...
                    this.shopHttp
                        .post("CustomerFee/CustomerHotelRefundFee", {
