<template>
  <div class="view" id="box">
    ...
    <el-table v-loading="tableLoading" size="small" algin="center" :data="tableList">
      <el-table-column size="small" align="center" prop="amount" label="代扣金额"></el-table-column>
      <el-table-column size="small" align="center" prop="deductedType" label="代扣类型"></el-table-column>
      <el-table-column size="small" align="center" prop="createUserName" label="操作人"></el-table-column>
      <el-table-column size="small" align="center" prop="creationTimeStr" label="代扣日期"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    queryData(size, index) {
      ...
      this.shopHttp
        .get(
          "CustomerFee/GetDeductedRecord?PageSize=" +
            (size || 10) +
            "&PageIndex=" +
            (index || 1) +
            "&DeductedType=" +
