  ...
  export default {
    ...
    methods: {
      ...
      handleCheck(row) { //处理审核
        this.shopHttp.post('SingleProductOrder/CheckChangePrice', { 'RecordId': this.checkPriceDto.RecordId, 'IsPass': this.checkPriceDto.IsPass, 'Reason': this.checkPriceDto.Reason })
          .then(res => {
