<template>
  <div id="box" class="view">
         ...
         <el-row :gutter="20">
             ...
             <el-col :span="7">
                 <el-form-item label="附件"  label-width="120px">
                    <el-button type="primary" icon="el-icon-picture-outline" size="small" @click="attachment">点击查看附件</el-button>
      ...
      <h4><span class="vercitals">| </span>发票信息</h4>
        <el-form >
         <el-row :gutter="20">
             <el-col :span="10">
         ...
         <el-row :gutter="20">
           ...
           <el-form-item label="领取方式" size="small"  label-width="120px">
              <span>{{invoiceList.receiveTypeName}}</span>
          </el-form-item>
...
export default {
      ...
      mounted () {
        ...
        this.groupHttp.get("/Invoice/GetInvoiceDetail?CusFeeId=" + this.$route.query.id).then(res =>{
      ...
      methods: {
          back(){
              //this.$router.push('/orderCenter/receivablesManagement')
          },
          attachment(){
