  ...
  <div id="box" class="view" v-loading="viewLoading">
    <h4><span class="verticals">| </span>收款客户</h4>
      ...
      <h4><span class="verticals">| </span>收款信息</h4>
       <el-row :gutter="24">
            <el-form ref = 'formData' :rules='rules' :model="formData" label-width="100px"  size="small">
                <el-row :gutter="18">
                    <el-col :span="7" class="elcol">
                        <el-form-item label="收款方式"  size="medium" prop='FeeMethod'>
                            <el-select class="inputs"  v-model="formData.FeeMethod" >
                                    <el-option
                    ...
                    <el-col :span="7" class="elcol" v-if = 'this.formData.FeeMethod == 3 ? true : false'>
                        <el-form-item label="收款银行" prop='BankAccountId'>
                            <el-select class="inputs" v-model="formData.BankAccountId" >
                                    <el-option
                    ...
                    <el-col :span="7" class="elcol" v-if = 'this.formData.FeeMethod == 2 ? true : false'>
                        <el-form-item label="银行账号" prop='TransferAccountNo'>
                ...
                <el-row :gutter="18">
                    <el-col :span="7" class="elcol">
                        <el-form-item label="收款流水号" prop='FeeSerialNo'>
                            <el-input class="inputs" v-model="formData.FeeSerialNo"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="7"  class="elcol">
                        <el-form-item label="币种" prop='Currency'>
                            <el-select class="inputs" v-model="formData.Currency">
                                <el-option
                ...
                <el-form-item label="附件"  prop = 'Attachment'>
                     <el-upload
                        ...
                        :file-list="fileData"
                        >
                        <el-button type="primary" class="margin_bottom">点击上传</el-button>
                    </el-upload>
                </el-form-item>
...
export default {
    ...
    methods:{
        ...
        jisuan(){
            ...
            // console.log(Number(this.formData.feeAmount))
            // console.log(amount)
            if(amount >= 0){
                this.feeDetails = [];
                console.log()
                ...
                obj.amount = amount;
                this.feeDetails.push(obj);
                console.log(this.customerFeeInitInfo.orders)
            }
        },
        //创建客户收款单
                            ...
                            if (res.data.isSuccess == true) {
                                ...
                                setTimeout(() => {
                                    if(text){
                                        ...
                                        this.$router.push({path:'/grouptour/offlineOrderList'})
                                    }
                                },500)
        ...
        //取消
      cancel(){
          this.$router.push('/grouptour/offlineOrderList')
      }
    },
    mounted(){
        var date = new Date();
