<template>
  <div class="view">
    ...
    <el-table :data="tableData" show-summary size="small" v-loading="table_loading">
      ...
      <el-table-column size="small" align="center" prop="shopName" label="门市"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      ...
      let url =
        WEB_API +
        `/GroupLineReport/ExportFinanceReport?FinanceReportType=${this.form.reportType}&TimeType=${
          this.form.TimeType
        }&LineTypeName=${this.form.lineTypeName}&TimeFrom=${BeginDate}&TimeTo=${EndDate}&ShopName=${
          this.form.ShopName
        }&SupplierName=${this.form.SupplierName}&LineName=${
          this.form.LineName
        }&TargetCityName=${this.form.TargetCityName}&OrderNo=${
          this.form.OrderNo
        }&PageSize=${this.pageSize}&PageIndex=${this.pageIndex}&BranchId=`;
