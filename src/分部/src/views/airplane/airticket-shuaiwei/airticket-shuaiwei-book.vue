	...
	<div class="view" v-loading="viewLoading">
		<el-form ref="form" :model="form" :rules="rule" class="demo-form-inline" label-width="80px" size="small">
			...
			<el-row  type="flex" class="info-row">
				...
				<!-- <a class="download-temp" size="small" href="http://120.76.20.11:8004/Upload/AirTicket/Airline/20180108/ee444dfce26c4a2b808364be5e43ef2a.xls" type="primary" download="filename">下载模板</a> -->
	...
	export default {
		...
		methods:{
			getInfo(){
				...
				this.airHttp.get(`api/Common/GetDetailsTop?operatingRecordId=${this.$route.query.operatingRecordId}&pricingSalesId=${this.$route.query.id}`)
				.then((res)=>{
					this.viewLoading=false;
					// if(res.data.isSuccess){
						var objects=res.data.objects[0];
						this.form.OperatingRecordId=objects.operatingRecordId;
