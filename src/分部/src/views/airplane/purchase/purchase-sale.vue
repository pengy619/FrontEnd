<template>
	<div class="view">
		...
		<el-row :gutter="20" type="flex" class="info-row">
			<el-col :span="6">开航日期：{{info.startTime?info.startTime.split('T')[0]:''}}</el-col>
			<el-col :span="6">停航日期：{{info.endTime?info.endTime.split('T')[0]:''}}</el-col>
		</el-row>
		<el-row :gutter="20" type="flex" class="info-row">
			<el-col :span="6">
		...
		<el-row :gutter="20" type="flex" class="info-row">
			...
			<el-col :span="6">采购日期：{{info.procurementDate?info.procurementDate.split('T')[0]:''}}</el-col>
		</el-row>
		<el-row :gutter="20" type="flex" class="info-row">
			<el-col :span="24">
				备注：{{info.remark}} 
