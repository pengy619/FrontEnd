<template>
  <div class="view">
      <div class="tab-div">
                ...
                <!-- 添加 -->
        <el-dialog title="添加景点等级" :visible.sync="dialogFormVisible_add" width="360px">
                <el-form :model="addDialogForm" :rules="rules" ref="addDialogForm">
                    <el-form-item label="景点等级" prop="paramName" size='small'>
                            <el-input v-model="addDialogForm.paramName" auto-complete="off" ></el-input>
                    </el-form-item>
                </el-form>
                <div slot="footer" class="dialog-footer">
                    <el-button type="primary" @click="addAttractionLevel('addDialogForm')" size='small'>确 定</el-button>
                </div>
        </el-dialog>

        <!-- 编辑 -->
           <el-dialog title="编辑景点等级" :visible.sync="dialogFormVisible_modify" width="410px">
            ...
            <div slot="footer" class="dialog-footer">
                <el-button type="primary" @click="modifyAttractionLevel('modifyDialogForm')" size='small'>确 定</el-button>
            </div>
        </el-dialog>
...
export default {
  ...
  methods: {
    ...
    queryData(pageSize,index){
      ...
      this.groupHttp
        .get("DictionaryData/GetDictionaryData?Type=1006").then(res => {
            console.log(res);
    ...
    //修改景点等级
    modifyAttractionLevel(formName) {
