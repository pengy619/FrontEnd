<template>
  <div class="view">
      <div class="tab-div">
                ...
                <!-- 添加 -->
        <el-dialog title="添加景点类型" :visible.sync="dialogFormVisible_add" width="360px">
                <el-form :model="addDialogForm" :rules="rules" ref="addDialogForm">
                    <el-form-item label="景点类型" prop="paramName" size='small'>
                            <el-input v-model="addDialogForm.paramName" auto-complete="off" ></el-input>
                    </el-form-item>
                </el-form>
                <div slot="footer" class="dialog-footer">
                    <el-button type="primary" @click="addAttractionType('addDialogForm')" size='small'>确 定</el-button>
                </div>
        </el-dialog>

        <!-- 编辑 -->
           <el-dialog title="添加景点类型" :visible.sync="dialogFormVisible_modify" width="410px">
            ...
            <div slot="footer" class="dialog-footer">
                <el-button type="primary" @click="modifyAttractionType('modifyDialogForm')" size='small'>确 定</el-button>
            </div>
        </el-dialog>
      ...
      this.groupHttp
        .get("DictionaryData/GetDictionaryData?Type=1005").then(res => {
          ...
          if (res.data.isSuccess === true) {
            ...
            this.attrction_type = res.data.objects;   
