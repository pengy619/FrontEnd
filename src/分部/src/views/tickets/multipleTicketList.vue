        ...
        @selection-change="tableSelectionChange">
            ...
            <el-table-column size="small" align="center"  label="操作" fixed="right" width='270'>
                <template slot-scope="scope">
                    <el-button type="text" size='small' @click='initAudit(scope.row)' :disabled='scope.row.status === 3 || scope.row.status === 4' class='table-button'>审核</el-button>
    ...
    export default{
        ...
        methods:{
            queryData(size,index){
                ...
                this.groupHttp.get("TicketProduct/GetProductPageList?ProductType=2&ProductNo="+this.ProductNo
