...
var airHttp = axios.create({
	baseURL: process.env.WEB_API,//:'http://120.76.20.11:6001',//深圳接口：http://183.237.199.242:6345
	timeout: 10000
});
...
// 统一错误提示
groupHttp.interceptors.response.use(function (response) {
...
export {airHttp,groupHttp,fileUpload,addressHttp}
